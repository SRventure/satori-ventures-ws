  ...
  return (
    <section id="focus" className="py-28 md:py-36">
      <div className="mx-auto w-full max-w-wide px-6 md:px-10">
        <p className="eyebrow mb-4">Where We Invest</p>
        ...
        <div className="mt-16 grid gap-7 lg:grid-cols-2">
          ...
          <motion.article
            {...reveal(0)}
            className="group relative overflow-hidden border border-ink-3/30 bg-bg-2 p-10 transition-colors duration-500 hover:border-gold/60 md:p-14 lg:row-span-2"
          >
            <div
              aria-hidden="true"
            ...
            />
            <span className="inline-block rounded-full border border-gold/50 bg-gold/10 px-4 py-1 font-sans text-[11px] font-medium uppercase tracking-[0.2em] text-gold">
              Featured thesis
            </span>
            ...
            <p className="mt-10 font-sans text-[13px] tracking-wide text-ink-2/80">
              <span className="text-gold">In portfolio —</span> {featured.companies}
            </p>
          </motion.article>
          ...
          {rest.map((f, i) => (
            ...
            >
              ...
              <p className="mt-7 font-sans text-[13px] tracking-wide text-ink-2/80">
                <span className="text-gold">In portfolio —</span> {f.companies}
              </p>
            </motion.article>
          ))}
        </div>
